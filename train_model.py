...
def main(args):
    ...
    TEST_DATASET_PATH = os.path.join(args.data, 'dogImages/test/')
...
#     else:
    ...
    # create hood for debugger
    hook = smd.Hook.create_from_json_file()
    hook.register_hook(model)
    
    model=train(model, train_loader, loss_criterion, optimizer, args.epochs, device=device, hook=hook)
    
    '''
    TODO: Test the model to see its accuracy
    '''
    test(model, test_loader, loss_criterion, device=device, hook=hook)
